...
app.use('/records', recordsRouter); //tells Express to attach all the routes from the previous module to the server, to the “/books” route - this ensures that inside the books router, we can use relative URL paths (e.g. instead of “/books/:id”, we just used “/:id”).
